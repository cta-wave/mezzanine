...
from video import genFlashSequence, genFrameImages, genSimpleFrameImages
...
if __name__ == "__main__":
    ...
    if frameFilenames is not None:
        ...
        # for the purpose of the WAVE mezzanine generator, only output simple frames of a single colour, that of the flash sequence
        frames = genSimpleFrameImages(pixelsSize, flashSequence, numFrames, BG_COLOUR=bg_colour, frameSkipChecker=skipChecker)
